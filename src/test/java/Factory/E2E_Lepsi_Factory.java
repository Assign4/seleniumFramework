...
public class E2E_Lepsi_Factory {

	@Factory(dataProvider="LepsiTestData")
	public Object[] E2E_Lepsi_Factory(Hashtable<String,String> data)
	{  
		return new Object[] {new E2E_Lepsi(data)};
	}
	...
	public static Object[][] creditAppSubmissiondatasets() throws IOException{
		...
		Object[][] rawdata = rf.universalDataProvider_v2("Data/Lepsi.xlsx","Datasheet");
